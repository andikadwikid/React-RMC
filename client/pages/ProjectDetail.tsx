  ...
  const projects: Project[] = [
    {
      ...
      readinessScore: 65,
      description: "Pengembangan sistem ERP terintegrasi untuk mengelola seluruh proses bisnis perusahaan mulai dari inventory, finance, HR, hingga customer relationship management.",
      objectives: [
      ...
      risks: [
        {
          ...
          impact: "High",
          mitigation: "Melakukan thorough analysis dan POC sebelum implementasi"
        },
        {
    ...
    },
    {
      ...
      readinessScore: 95,
      description: "Pengembangan aplikasi mobile banking dengan fitur lengkap untuk nasabah Bank Digital Nusantara, termasuk transfer, pembayaran, investasi, dan layanan perbankan digital lainnya.",
      objectives: [
      ...
      technologies: ["React Native", "Node.js", "MongoDB", "Firebase", "JWT", "Kubernetes"],
    ...
    },
    {
      ...
      readinessStatus: "completed",
      readinessScore: 100,
      description: "Pengembangan dashboard analytics untuk monitoring dan analisis data bisnis real-time dengan visualisasi interaktif dan reporting otomatis.",
      objectives: [
      ...
      technologies: ["Vue.js", "Python", "Apache Spark", "PostgreSQL", "Redis", "Grafana"],
    ...
    },
    {
      ...
      readinessStatus: "in-progress",
      readinessScore: 40,
      description: "Pengembangan platform e-commerce lengkap dengan fitur marketplace, payment gateway, inventory management, dan seller dashboard untuk mendukung ekosistem digital commerce.",
      objectives: [
      ...
      technologies: ["Next.js", "Microservices", "PostgreSQL", "Redis", "RabbitMQ", "Docker", "AWS"],
      location: "Jakarta, Indonesia", 
    ...
    },
    {
      ...
      readinessScore: 10,
      description: "Pengembangan sistem manajemen HR komprehensif untuk mengelola employee lifecycle, payroll, performance management, dan talent development.",
      objectives: [
      ...
      technologies: ["Angular", "Spring Boot", "MySQL", "Apache Kafka", "Jenkins"],
    ...
    },
    {
      ...
      readinessStatus: "in-progress",
      readinessScore: 75,
      description: "Sistem manajemen inventory terintegrasi dengan WMS (Warehouse Management System) untuk optimasi supply chain dan tracking real-time.",
      objectives: [
      ...
      technologies: ["React", "Java Spring", "Oracle DB", "Apache Kafka", "TensorFlow"],
      location: "Surabaya, Indonesia",
    ...
    return (
      <div className="p-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Project dengan ID "{projectId}" tidak ditemukan.</p>
          <Link to="/projects">
            <Button>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-700 text-sm">{project.projectManager}</p>
              </div>
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Client Contact</h4>
        ...
        <Card>
          ...
          <CardContent>
            {project.risks && project.risks.length > 0 ? (
                ...
                {project.risks.map((risk, index) => (
                  <div key={index} className="border rounded-lg p-3 bg-gray-50">
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="font-medium text-gray-900 text-sm">{risk.description}</h4>
              ...
              <p className="text-gray-500 text-sm">Tidak ada risk yang teridentifikasi</p>
            )}
          </CardContent>
        </Card>
      </div>
