...
const QuickRiskCaptureDetailModal = memo(
  ({
    ...
    projectName,
    quickRiskData,
  }: QuickRiskCaptureDetailModalProps) => {
            ...
            <DialogTitle className="flex items-center gap-3">
              ...
              <div>
                <span className="text-orange-900">
                  Quick Risk Capture - Detail View
                </span>
              ...
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge className="bg-orange-100 text-orange-800">
                    {quickRiskData.totalRisks} Risk
                    {quickRiskData.totalRisks > 1 ? "s" : ""}
                  </Badge>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                  ...
                  {quickRiskData.completedAt && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-orange-900">
                        {new Date(quickRiskData.completedAt).toLocaleDateString(
                          "id-ID",
                        )}
                      </span>
                    </div>
                ...
                <div className="text-xs text-orange-700">
                  <p className="flex items-start gap-2">
                    ...
                    Quick Risk Capture adalah data risiko yang diinput langsung
                    oleh user untuk identifikasi cepat risiko project. Data ini
                    dapat diverifikasi dan dinilai lebih lanjut oleh Risk
                    Officer.
                  </p>
                </div>
              </CardContent>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      {risk.risikoSaatIni && (
                        ...
                        >
                          ...
                          {getRiskLevelLabel(risk.risikoSaatIni.level)}
                        </Badge>
                      )}
                    </div>
                  </CardHeader>
          ...
          <DialogFooter className="p-6 border-t bg-gray-50">
            <div className="flex items-center justify-between w-full">
              <div className="text-sm text-gray-600">
                ...
                Quick Risk Capture dapat diverifikasi melalui dialog verifikasi
                project readiness
              </div>
